package com.lnavarro.heroescleanarchitectureconcept.app.ui.people.adapter;
...
import com.lnavarro.heroescleanarchitectureconcept.app.widget.CircleTransformation;
...
public class PeopleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PeopleAdapter(Context context, ArrayList<Heroe> data) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        viewHolder = new PeopleAdapter.HeroesViewHolder(v);
